...
# # Append the new data to the existing sheet or create a new sheet
# df.to_excel(writer, index=False, header=False, startrow=writer.sheets['Sheet1'].max_row if 'Sheet1' in writer.sheets else 0)
...
excel_file = "thisdic.xlsx"

try:
    # Try to load the existing file and append to it
...
print("Data appended to the Excel sheet...")
